...
struct AmbientParticlesView: View {
    ...
    init(count: Int = 20, colors: [Color] = [.white, .purple.opacity(0.5), .cyan.opacity(0.3)]) {
            ...
            .onAppear {
                particles = (0..<particleCount).map { index in
                    Particle(
                        ...
                        opacity: Double.random(in: 0.1...0.3), // Slightly more visible for kids
                ...
                GeometryReader { geo in
                    LinearGradient(
                        stops: [
                            ...
                            .init(color: .white.opacity(0.3), location: 0.45), // Brighter for kids
